...
async function mailTicket(order) {
  ...
  try {
    ...
    attachments.push({ filename: `wgma-ticket-${order.reference}.jpg`, content: png, type: 'image/jpeg' });
  ...
  attachments.push({ filename: `wgma-qr-${order.reference}.png`, content: qr, type: 'image/png' });
